...
export default function Navbar() {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration bg-gradient-to-b from-white via-white to-transparent ${hasUserScrolled ? 'bg-white' : 'bg-transparent'}`}
    >
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <Link
            ...
            <motion.div
              ...
              className="w-[250px] h-[80px] relative">
              <Image
                src="/home/logo1.png"
            ...
            {roleBasedNav.map((item) => {
              ...
              return (
                <Link
                  key={item.name}
                  href={item.link || "/"}
                  className={`text-base font-medium transition-colors ${pathname === item.link
                    ? "text-[#E67E22]"
