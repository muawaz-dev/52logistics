        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          >
            <div className="relative z-10 rounded-[3rem] overflow-hidden shadow-2xl bg-gray-100 w-96 h-110 flex items-center justify-center border-8 border-white">
              ...
              <div className="w-full h-full bg-linear-to-br from-gray-200 to-gray-300 flex items-center justify-center">
                 <Image
                 src="/amazon-fba-fbm/info-image.jpeg"
          ...
          >
            <h2 className="text-primary text-4xl md:text-5xl font-black leading-tight mb-8 tracking-tight">
              Amazon 
              <span className="mx-2 text-secondary">fulfillment</span> made
              easy
            </h2>
            
            <div className="space-y-6 text-gray-700">
              <p className="text-gray-700 font-semibold tracking-wide text-md md:text-lg leading-relaxed  ">
                Maximize your ecommerce potential with specialized Amazon FBA and FBM services. With comprehensive solutions designed to streamline and scale your order fulfillment operations, your products will reach millions of customers swiftly and efficiently.
              </p>
              <p className="text-gray-700 font-medium tracking-wide text-md md:text-lg leading-relaxed opacity-80">
                Enjoy expert FBA handling, with easy management of storage, packaging, and shipping directly through Amazon’s network, so you can focus on strategy and growth. Or, maintain flexibility, control, and direct connections with your customers with Amazon FBM.
              </p>
            </div>
